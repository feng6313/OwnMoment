...
struct FrametenView: View {
    ...
    @State private var userNameColor: Color? = nil // 用户名颜色
    
    // 添加动态尺寸变量 - 修改为矩形371*228
    ...
    @State private var displayHeight: CGFloat = 228
    
    // 显示区域的尺寸常量 - 修改为矩形区域
    private var displayAreaSize: CGFloat {
        return displayWidth // 矩形区域，使用宽度作为基准
    }
        ...
        ZStack {
            ...
            VStack(spacing: 0) {
                ...
                ZStack {
                    ...
                    // 在白色背景上层添加矩形图片显示区域，上边缘与背景上边缘对齐
                    ZStack {
                        Rectangle()
                            .fill(Color.white) // 暂用白色填充
                            .frame(width: 371, height: 228)
                    ...
                    .offset(y: -455/2 + 228/2) // 图片显示区上边缘与背景上边缘对齐
                    ...
                    .offset(y: -455/2 + 48 + 230) // 位于白色背景下方48点处，向下移动230点
...
struct FrametenView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        NavigationView {
            FrametenView(selectedImage: nil, frameIndex: 0)
        }
    }
}
        ...
        if #available(iOS 16.0, *) {
            ...
            let renderer = ImageRenderer(content:
                ZStack {
                    ...
                    .offset(y: -frameHeight/2 + displayHeight/2) // 图片显示区上边缘与背景上边缘对齐
                    ...
                    .offset(y: -frameHeight/2 + 48 + 230) // 位于白色背景下方48点处，向下移动230点
